		...
		<>
			{
				loadingState.isLoading
					...
					:
					<Router>
						<Header loggedIn={loggedIn} setUpdate={setUpdate} currentUser={currentUser} domain={domain} />
						<main>
							{
								loggedIn
									?
									...
									:
									<Routes>
										<Route path="/register" element={<PageRegister setUpdate={setUpdate} domain={domain} />} />
										<Route path="/login" element={<PageLogin setUpdate={setUpdate} domain={domain} />} />
